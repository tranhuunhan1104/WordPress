...
class ZendvnMpAdmin{
	...
	public function create_form($args){
		...
		if($args['name']== 'new_title_input'){
			...
			// 	echo $htmlObj->password('zendvn_mp_name[zendvn_mp_new_title]', '123456',$attr); 
			...
			echo $htmlObj->textarea('zendvn_mp_name[zendvn_mp_new_title]', 'Viet noi dung vao day',$attr); 
			...
			// 			'class'=>'abc',
			// 			'style' => 'width: 300px;',
			// 			'onClick'=> "alert('Xin chao moi nguoi');"
			// 		);
