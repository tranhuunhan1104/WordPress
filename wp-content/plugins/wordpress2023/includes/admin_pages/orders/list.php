<div class="wrap">
    ...
    <ul class="subsubsub">
        <li class="all"><a href="admin.php?page=wp2023-orders" class="current">Tất cả <span class="count">(3)</span></a>
            |</li>
        <li class="publish"><a href="admin.php?page=wp2023-orders&status=pending">Đơn hàng mới</a> |</li>
        <li class="publish"><a href="admin.php?page=wp2023-orders&status=completed">Đơn hàng đã hoàn thành</a> |
        </li>
    ...
    <form id="posts-filter" method="get">
        ...
        <div class="tablenav top">
            ...
            <?php 
            include WP2023_PATCH .'/includes/templates/elements/element_paginate.php';
             ?>
